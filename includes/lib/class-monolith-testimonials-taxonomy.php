...
class monolith_testimonials_Taxonomy {
	...
	public function register_taxonomy () {
        ...
        $labels = array(
            ...
            'update_item' => sprintf( __( 'Update %s' , 'monolith-testimonials' ), $this->single ),
            'add_new_item' => sprintf( __( 'Add New %s' , 'monolith-testimonials' ), $this->single ),
            'new_item_name' => sprintf( __( 'New %s Name' , 'monolith-testimonials' ), $this->single ),
            'parent_item' => sprintf( __( 'Parent %s' , 'monolith-testimonials' ), $this->single ),
            'parent_item_colon' => sprintf( __( 'Parent %s:' , 'monolith-testimonials' ), $this->single ),
            'search_items' =>  sprintf( __( 'Search %s' , 'monolith-testimonials' ), $this->plural ),
            'popular_items' =>  sprintf( __( 'Popular %s' , 'monolith-testimonials' ), $this->plural ),
            'separate_items_with_commas' =>  sprintf( __( 'Separate %s with commas' , 'monolith-testimonials' ), $this->plural ),
            'add_or_remove_items' =>  sprintf( __( 'Add or remove %s' , 'monolith-testimonials' ), $this->plural ),
            'choose_from_most_used' =>  sprintf( __( 'Choose from the most used %s' , 'monolith-testimonials' ), $this->plural ),
