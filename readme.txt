...
Installing "monolith_testimonials" can be done either by searching for "monolith_testimonials" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
